package com.sukongcheng.suboot.code.create;
...
//        templateConfig.setXml("/templates/mapper.xml");
        ...
        pc.setParent("com.sukongcheng.suboot");
        ...
        focList.add(new FileOutConfig("/templates/controllerMy.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/com/sukongcheng/suboot/controller/admin/" + tableInfo.getControllerName() + StringPool.DOT_JAVA;
            }
        });
